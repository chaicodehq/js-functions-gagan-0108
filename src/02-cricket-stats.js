...
export const getPlayerCard = (player) => {
  ...
  if (player===null || player === undefined || !player || typeof player !== "object" || !player.name  ) return null 

  const { name, runs, balls, runsConceded, overs, totalRuns,innings, notOuts } = player;
